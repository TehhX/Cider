...
extern inline char *cider_to_extension(__cider_str_mut file);
    ...
    extern inline void cider_fslash_delims(__cider_str_mut file);
#else
    ...
    extern inline void cider_bslash_delims(__cider_str_mut file);
...
extern inline char *cider_data_filepath();
